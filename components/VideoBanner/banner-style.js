    ...
    "& $videoBg": {
      ...
      backgroundImage:
        theme.palette.type === "light"
          ? `linear-gradient(95deg, ${theme.palette.primary.main} 0%, ${theme.palette.secondary.main} 110%)`
          : `linear-gradient(95deg,  ${theme.palette.primary.dark} 0%, ${theme.palette.secondary.dark} 110%)`,
      [theme.breakpoints.down("sm")]: {
        display: "none",
      },
    },
